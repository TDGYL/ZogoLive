...
/// 关于我们页
/// 展示项目Logo、版本号及用户协议、隐私协议、官网地址入口列表
          ...
          child: Column(
            children: [
              _buildListItem(
                ...
                onTap: () {
                  _pushToWebView(title: '用户协议', url: _userAgreementUrl);
                },
              ),
              ...
              _buildListItem(
                ...
                trailing: const Icon(Icons.chevron_right,
                    size: 14, color: G5Colors.textSecondary),
                onTap: () {
                  _pushToWebView(title: '隐私协议', url: _privacyAgreementUrl);
                },
              ),
              const Divider(height: 1, color: G5Colors.pitchBorder),
              _buildListItem(
